...
Route::group(['namespace' => 'App\Http\Controllers\Personal', 'prefix' => 'personal', 'middleware' => ['auth', 'verified']], function () {
    ...
    Route::group(['namespace' => 'Comment', 'prefix' => 'comments'], function () {
        ...
        Route::get('/{comment}/edit', "EditeController")->name('personal.comment.edite');
...
Route::group(['namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'admin', 'middleware' => ['auth', 'admin', 'verified']], function () {
    ...
    Route::group(['namespace' => 'Post', 'prefix' => 'posts'], function () {
        ...
        Route::get('/{post}/edit', "EditeController")->name('admin.post.edit');
    ...
    Route::group(['namespace' => 'Category', 'prefix' => 'categories'], function () {
        ...
        Route::get('/{category}/edit', "EditeController")->name('admin.category.edit');
    ...
    Route::group(['namespace' => 'Tag', 'prefix' => 'tags'], function () {
        ...
        Route::get('/{tag}/edit', "EditeController")->name('admin.tag.edit');
    ...
    Route::group(['namespace' => 'User', 'prefix' => 'users'], function () {
        ...
        Route::get('/{user}/edit', "EditeController")->name('admin.user.edit');
